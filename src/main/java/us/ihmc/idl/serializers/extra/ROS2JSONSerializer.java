...
/**
 * JSON Serializer for ROS2Message objects. Serializes ROS2Messages to JSON representation using Jackson.
 *
 * This replaces the TopicDataType-based JSONSerializer with a version that works directly with
 * ROS2Message objects.
 *
 * @author Generated
 *
 ...
 */
public class ROS2JSONSerializer<T extends ROS2Message<T>> extends ROS2AbstractSerializer<T>
{
   /**
    * Create a JSON serializer for the given message type.
    *
    ...
    */
   public ROS2JSONSerializer(Class<T> messageClass, String messageName)
   {
      super(messageClass, messageName, new ObjectMapper(new JsonFactory()));
   }
    ...
    * @param messageClass class of the ROS2Message to serialize
    */
   public ROS2JSONSerializer(Class<T> messageClass)
   {
