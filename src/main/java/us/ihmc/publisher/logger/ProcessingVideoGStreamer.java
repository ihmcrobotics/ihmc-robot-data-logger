 ...
 * @author Tend Wong
 */
public class ProcessingVideoGStreamer {
    // Size of Java queue
    ...
    public static void main(String args[]) throws Exception {
        ...
        Bin videoBin = Gst.parseBinFromDescription(
                "autovideosrc ! videoconvert ! capsfilter caps=video/x-raw,width=640,height=480 ! appsink name=videoAppSink",
                true);
...
//        playbin.play();
        ...
        if (hasAudio) {
            ...
            pipeline = (Pipeline) Gst.parseLaunch(
                    "appsrc name=videoAppSrc " +
                            "! capsfilter caps=video/x-raw,width=640,height=48 " +
                            "! filesink sync=false name=filesink");
...
//        videoAppSrc.connect((AppSrc.NEED_DATA) videoAppSrcListener);
        ...
        while (true) {
            ...
            filesink.set("location", "fakepath.mp4");// "capture" + System.currentTimeMillis() + ".mp4");
