...
public interface YoVariableClientInterface
{
   ...
   /**
    * Set the variable update rate for this client Note: If the controller does not send monotonically
    * increasing timestamps this could result in no received data.
    *
   ...
   /**
    * Disconnect the current session Reconnecting to a compatible session is possible
    */
   void disconnect();
