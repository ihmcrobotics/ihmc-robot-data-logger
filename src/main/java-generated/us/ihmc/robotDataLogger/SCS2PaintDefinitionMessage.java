...
public class SCS2PaintDefinitionMessage extends Packet<SCS2PaintDefinitionMessage> implements Settable<SCS2PaintDefinitionMessage>, EpsilonComparable<SCS2PaintDefinitionMessage>
{
   ...
   public SCS2PaintDefinitionMessage()
   {
      ...
      fieldNames_ = new us.ihmc.idl.IDLSequence.StringBuilderHolder (16, "type_d");
      fieldValues_ = new us.ihmc.idl.IDLSequence.StringBuilderHolder (16, "type_d");
   }

   public SCS2PaintDefinitionMessage(SCS2PaintDefinitionMessage other)
   {
      this();
      set(other);
   }

   public void set(SCS2PaintDefinitionMessage other)
   {
      type_.setLength(0);
   ...
   @Override
   public boolean epsilonEquals(SCS2PaintDefinitionMessage other, double epsilon)
   {
   ...
   public boolean equals(Object other)
   {
      if(other == null) return false;
      if(other == this) return true;
      if(!(other instanceof SCS2PaintDefinitionMessage)) return false;

      SCS2PaintDefinitionMessage otherMyClass = (SCS2PaintDefinitionMessage) other;
   ...
   public java.lang.String toString()
   {
      ...
      builder.append("SCS2PaintDefinitionMessage {");
      builder.append("type=");
